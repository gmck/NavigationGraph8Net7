...
namespace com.companyname.navigationgraph8net7
{
    [Application]
    public class NavigationGraph8ApplicationNet7 : Application, Application.IActivityLifecycleCallbacks
    {
        protected readonly string logTag = "Nav-ApplicationClass";
        protected NavigationGraph8ApplicationNet7(IntPtr javaReference, JniHandleOwnership transfer) : base(javaReference, transfer)
        {

        }
        public NavigationGraph8ApplicationNet7() { }
